...
Version:        %{majorver}
Release:        %{?preminorver:0.}%{fedorarel}%{?preminorver:%{rpmminorver}}%{?dist}.qg
...
rm -rf \
	.autotest .gemtest .rubocop.yml .togglerc \
...
%changelog
*Wed Feb 3 2016 <vitvegl@quintagroup.org> - 10.5.0-1
- v10.5.0

* Wed Feb 3 2016 <vitvegl@quintagroup.org> - 10.4.2-100
- rebuilt for fc21
